 ...
 */
$db_url = 'mysqli://root@localhost/gi';
$db_prefix = '';
...
switch ($_SERVER['HTTP_HOST']) {
	case 'jonidev.devcloud.acquia-sites.com':
	case 'jonitest.devcloud.acquia-sites.com':
	case 'joni.devcloud.acquia-sites.com':
	case 'changemyworldnow.com':
	case 'www.changemyworldnow.com':
		if (file_exists('/var/www/site-php/joni')) {
		  require('/var/www/site-php/joni/joni-settings.inc');
    } elseif (file_exists('/var/www/site-php/changemyworldnow')) {
