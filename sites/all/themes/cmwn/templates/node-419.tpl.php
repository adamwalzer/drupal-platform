...
<div class="two-col">
  ...
  <div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix">
    ...
    <div class="content">
      ...
      <img src="<?php echo url(drupal_get_path('theme', 'cmwn')); ?>/assets/img/dear-jack.jpg" />
      <div class="jack-button-wrap"><a class="jack-button" href="#ask-jack"></a></div>
      <?php echo views_embed_view('jack_jill', 'default', 'jack'); ?>
      <a id="ask-jack" name="ask-jack"></a>
