...
class OAuthServer {
   ...
   */
  public function fetch_access_token(&$request, $request_type = "request") {//lwd added parameter due to bug
    $this->get_version($request);

    $consumer = $this->get_consumer($request);

    // requires authorized request token
    $token = $this->get_token($request, $consumer, $request_type);//this was request, now can be request or access //lwd
  ...
  private function get_token($request, $consumer, $token_type="access") {
    $token_field = $request instanceof OAuthRequest
         ...
         watchdog('cmwn_token_field',print_r($token_field,true));
